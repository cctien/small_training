...
subprocess.run('python -m spacy download de_core_news_sm'.split())
...
parser = argparse.ArgumentParser(description='PyTorch Translation transformer Example')
parser.add_argument(
    '--download_data_only', action='store_true', default=False, help='download the data'
    )
cmdln_args = parser.parse_args()
if cmdln_args.download_data_only:
    raise SystemExit(0)
